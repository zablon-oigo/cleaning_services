...
function Navbar() {
  ...
  return (
    <>
      <header className="min-h-screen w-full" style={bgImage}>
        ...
        <section className={`${menu?'translate-x-0':'-translate-x-full'} duration-500 z-10 transition-transform md:hidden absolute top-[90px]  left-0 -translate-x-1/2 w-full bg-white h-[450px] flex justify-center gap-6 items-center px-10 flex-col`}>
        ...
        <div className="md:my-60 my-10 w-full md:w-2/3" data-aos='zoom-in-up' data-aos-duration='3000' data-easing='linear'>
